...
{
    class BackTestSample2: TRx.BackTest.Template
    {
        public BackTestSample2(string[] args) : base(args)
        {
        }
        ...
        {
            Template tmp = new BackTestSample2(args);
            tmp.Do();
        }
        ...
        {
            Console.WriteLine("Оverride BackTest.Sample2.Initialize()");
        ...
        {
            Console.WriteLine("Оverride BackTest.Sample2.SetupStrategy()");
        ...
        {
            Console.WriteLine("Оverride BackTest.Sample2.ConsoleHandlerB()");
