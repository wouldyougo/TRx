...
{
    public class SellSpreadFactory:IGenericFactory<double>
    {
        ...
        public SellSpreadFactory(IEnumerable<StrategyHeader> leftLeg, IEnumerable<StrategyHeader> rightLeg, IQuoteProvider quoteProvider)
        {
        ...
        public double Make()
        {
            ...
            return Math.Round(bidSum / offerSum, 4);
        }
