...
{
    public class ReversOnBar1:AddedItemHandler<Bar>
    {
        ...
        public ReversOnBar1(StrategyHeader strategyHeader, IDataContext tradingData, ObservableQueue<Signal> signalQueue, ILogger logger)
