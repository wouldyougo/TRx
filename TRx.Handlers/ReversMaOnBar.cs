...
{
    public class ReversMaOnBar:AddedItemHandler<Bar>
    {
        ...
        public ReversMaOnBar(StrategyHeader strategyHeader, IDataContext tradingData, ObservableQueue<Signal> signalQueue, ILogger logger)
