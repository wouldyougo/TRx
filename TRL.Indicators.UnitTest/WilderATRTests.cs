...
{
    [TestClass]
    public class WilderATRTests
    {
        [TestMethod]
        public void Indicators_WilderATR_test()
        {
            ...
            IEnumerable<double> result = WilderATR.Values(bars, 5);
            ...
            Assert.AreEqual(54.8, result.ElementAt(4));
            Assert.AreEqual(47.04, Math.Round(result.ElementAt(5), 2));
            Assert.AreEqual(48.432, Math.Round(result.ElementAt(6), 3));
