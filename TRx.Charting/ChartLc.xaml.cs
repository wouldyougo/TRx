            ...
            SeriesCollection = new SeriesCollection
            {
                new OhlcSeries
                {
                    Values = new ChartValues<OhlcPoint>
                    {
                        ...
                        new OhlcPoint(32, 35, 30, 32), //this is an alpha version, the first param should be date time
                        new OhlcPoint(33, 38, 31, 37), //sadly i am having some troubles with datetimes right now...
