...
namespace TRL.Common.Test.Models
{
    ...
    public class SignalTests
    {
        ...
        public void TradeSignal_ToString()
        {
            ...
            string result = String.Format("Signal Id: {0}, DateTime: {1}, TradeAction: {2}, OrderType: {3}, Price: {4}, Stop: {5}, Limit: {6}, Amount: {7}, StrategyId: {8}, BarDateId: {9}",
            ...
            ts.Id, ts.DateTime, ts.TradeAction, ts.OrderType, ts.Price.ToString("0.0000", ci), ts.Stop.ToString("0.0000", ci), ts.Limit.ToString("0.0000", ci), ts.Strategy.Amount.ToString("0.0000", ci), ts.Strategy.Id, ts.BarDateId);
        ...
        {
            string signalString = "1, 01.01.2013 12:24:40, Buy, Limit, 150000.0000, 149000.0000, 155000.0000, 8.0000, 1, 0";
